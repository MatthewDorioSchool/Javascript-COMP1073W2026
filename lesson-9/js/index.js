...
Game.prototype.description = function() {
  return `${this.title} is a ${this.genre} game with ${this.players} players online.`;
}
...
========================================= */
const game3 = new game1.constructor("Fantasy Quest", "RPG", 500);
...
Game.prototype.isPopular = function() {
  return this.players > 1000 ? `${this.title} is popular!` : `${this.title} has a small community.`;
}