...
myLink.textContent = "MDN Learning Resources";
myLink.href = "https://developer.mozilla.org/en-US/docs/JavaScript";
...
addTextButton.addEventListener("click", () => {
  ...
  factPara.textContent = randomFact;
  factPara.classList.add("highlight");
  section.appendChild(factPara);
  funFacts.push(factPara);
...
document.addEventListener("mousemove", e => {
  ...
  const blue = Math.min(255,Math.floor(e.clientY / window.innerHeight*255));
