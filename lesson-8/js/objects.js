...
const person ={
    ...
    gender: "Female",
    interests:["swimming","Martial Arts","camping"],
    greeting(){
        //alert(`Hi, I am ${this.name.first} and I have ${this.course} and I enjoy ${this.interests}`)
    
    return `Hi, I am ${this.name.first} and I have ${this.course} and I enjoy ${this.interests}`}
};
