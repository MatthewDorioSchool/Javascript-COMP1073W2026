...
//Arrow function:is a shorter way to write a function in JS
/*
...
origSevenArray = origFiveArray.unshift('Buffalo Sabers');
output.textContent = origSevenArray;
...
//includes():check if a value exists; returns true or false
